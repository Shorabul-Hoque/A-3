...
-- DESCRIPTION: Completed DDL Schema, Data Insertion, and Required Queries
...
-- Query 4: Retrieve match booking details with User's full name and scheduled Match fixture.
SELECT b.booking_id, u.full_name, m.fixture, b.total_cost
FROM Bookings b
INNER JOIN Users u ON b.user_id = u.user_id
INNER JOIN Matches m ON b.match_id = m.match_id;

-- Query 5: Comprehensive list of all users and booking IDs, including those who have never bought a ticket.
...
-- Query 7: Retrieve top 2 most expensive matches by base price, skipping the absolute highest premium match.
SELECT match_id, fixture, base_ticket_price
FROM Matches
